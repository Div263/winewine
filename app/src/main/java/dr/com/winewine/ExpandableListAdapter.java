...
/**
 * Created by divyaraghavan on 1/20/15.
 */
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        checkBoxListChild.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(((CheckBox)v).isChecked()){
                        FormOutput.getInstance().formOutput.put(childText,Boolean.TRUE);
                }
                else
                    FormOutput.getInstance().formOutput.put(childText,Boolean.FALSE);
            }
        });
        return convertView;
    }
